...
namespace Akka.Remote
{
    ...
    public static class MessageSerializer
    {
        ...
        public static SerializedMessage Serialize(ActorSystem system, Address address, object message)
        {
            ...
            SerializedMessage messageBuilder = new SerializedMessage
            {
            ...
            if (serializer2 != null)
            {
                ...
                {
                    messageBuilder.MessageManifest=ByteString.CopyFromUtf8(manifest);
                }
            }
            else
            {
                if (serializer.IncludeManifest)
                    messageBuilder.MessageManifest = ByteString.CopyFromUtf8(message.GetType().AssemblyQualifiedName);
            }
